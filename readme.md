...
2. Running mongodb localy ( You can skip this step if you want to use mongo atlas in the cloud).
...
3. create a .env file and past this variables

```

PORT=8011
# If you want to use mongo atlas past your srv string here.
MONGO_URI=mongodb://localhost:27017/user-data
